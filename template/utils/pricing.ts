...
export let WHITELIST_TOKENS: string[] =
  '0x4200000000000000000000000000000000000006,0xd9aaec86b65d86f6a7b5b1b0c42ffa531710b6ca,0x2ae3f1ec7f1f5012cfeab0185bfc7aa3cf0dec22,0xb6fe221fe9eef5aba221c348ba20a1bf5e73624c,0x50c5725949a6f0c72e6c4a641f24049a917db0cb,0x417ac0e078398c154edfadd9ef675d30be60af93,0x833589fcd6edb6e08f4c7c32d4f71b54bda02913'.split(
    ',',
  )

// prettier-ignore
let STABLE_COINS: string[] =
  '0xd9aaec86b65d86f6a7b5b1b0c42ffa531710b6ca,0x50c5725949a6f0c72e6c4a641f24049a917db0cb,0x417ac0e078398c154edfadd9ef675d30be60af93,0x833589fcd6edb6e08f4c7c32d4f71b54bda02913'.split(
    ',',
  )
      ...
      if (pool.liquidity.gt(ZERO_BI)) {
        if (pool.token0 == token.id) {
          ...
          if (
            ...
            (ethLocked.gt(MINIMUM_ETH_LOCKED) ||
              WHITELIST_TOKENS.includes(pool.token0.toHexString()))
          ) {
        ...
        if (pool.token1 == token.id) {
          ...
          if (
            ethLocked.gt(largestLiquidityETH) &&
            (ethLocked.gt(MINIMUM_ETH_LOCKED) ||
              WHITELIST_TOKENS.includes(pool.token1.toHexString()))
          ) {
            largestLiquidityETH = ethLocked;
...
export function getTrackedAmountETH(
  ...
  if (
    ...
    return tokenAmount0
      .times(derivedETH0)
      .plus(tokenAmount1.times(derivedETH1));
  }
