...
export function handleSwap(event: SwapEvent): void {
  ...
  let amount0 = convertTokenToDecimal(event.params.amount0, token0)
  let amount1 = convertTokenToDecimal(event.params.amount1, token1)
  let protocolFeeAmount0 = convertTokenToDecimal(event.params.protocolFeesToken0, token0)
  let protocolFeeAmount1 = convertTokenToDecimal(event.params.protocolFeesToken1, token1)
